...
class Employee:
    def __init__(self,root):
        ...
        lbl_empid.grid(row=0,column=0,padx=5,pady=10,sticky=W)
        ...
        lbl_gender.grid(row=3,column=0,pady=10,sticky=W)
        ...
        lbl_doj.grid(row=5,column=0,pady=10,sticky=W)
    ...
    def delete_data(self):
        ...
        id = self.employee_table.item(self.employee_table.selection_remove())
        collection.delete_one({"Employee ID":id})
        # self.message['text'] = ''
        # try:
