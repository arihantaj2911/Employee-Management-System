...
class pay:
    ...
    def __init__(self, window):
        ...
        # Ammount Input
        Label(Upper_frame, text='Amount: ',font=('arial',15,'bold'),bg='white').grid(row=1, column=2,padx=20,pady=10,sticky=W)
    ...
    def validation(self):
        ...
        if len(self.E_id.get()) == 0:
            messagebox.showinfo('Error','Enter correct E_Id',parent=self.wind)
            return False
        elif(self.E_id.get().isalpha()):
            messagebox.showinfo('Error','Invalid E_ID',parent=self.wind)
            return False

        elif len(self.P_id.get()) == 0:
            messagebox.showinfo('Error','Enter correct P_Id',parent=self.wind)
            return False

        elif(self.P_id.get().isalpha()):
            messagebox.showinfo('Error','Invalid P_ID',parent=self.wind)
            return False

        elif len(self.P_Date.get()) == 0:
            messagebox.showinfo('Error','Enter correct P_date',parent=self.wind)
            return False

        

        elif(self.P_Date.get().isalpha()):
            messagebox.showinfo('Error','Enter Correct Date',parent=self.wind)
            return False


        elif len(self.Ammount.get()) == 0:
            messagebox.showinfo('Error','Enter correct Amount',parent=self.wind)
            return False

        elif(self.Ammount.get().isalpha()):
            messagebox.showinfo('Error','Enter Correct Amount',parent=self.wind)
            return False

        elif len(self.Acc_No.get()) == 0:
            messagebox.showinfo('Error','Enter correct Acc_No',parent=self.wind)
            return False

        elif(self.Acc_No.get().isalpha()):
            messagebox.showinfo('Error','Enter Correct Acc_No',parent=self.wind)
            return False
