...
class Employ:
    ...
    def validation(self):
        ...
        if len(self.id.get()) == 0:
        ...
        elif len(self.doj.get()) == 0:
            messagebox.showinfo('Error','Enter correct DOJ',parent=self.wind)
            return False
        ...
        elif(self.salary.get().isalpha()):
            messagebox.showinfo('Error','Enter Correct Salary',parent=self.wind)
            return False

        elif len(self.mobile.get()) == 0:
            messagebox.showinfo('Error','Enter correct mobile',parent=self.wind)
            return False
            ...
            messagebox.showinfo('Error','Enter correct Email',parent=self.wind)
            return False


        elif len(self.email.get()) == "^[a-zA-Z0-9-_] +@[a-zA-Z0-9]+\.[a-z]{1,3}$":
            return True
        # def solve(s):
